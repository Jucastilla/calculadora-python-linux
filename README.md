...
*Observação: > Configurei as permissões do arquivo para que o proprietário tenha apenas leitura e escrita (chmod 644). Por não possuir permissão de execução direta, o script deve ser chamado através do interpretador Bash com o comando:
bash calculadora.sh*
